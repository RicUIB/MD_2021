---
title: "PRESENTACION: Ejemplo taller datos Netflix"
author: "Ricardo"
...
# Algunos estadísticos  y gráficos básicos
...
La similitud coseno de dos  vectores  de $\mathbb{R}^n$ no nulos $A=(A_1,A_2,\ldots,A_n)$ y $B=(B_1,B_2,\ldots,B_n)$
...
## Cálculo de la similitud coseno en paralelo
...
#Algunos ejemplos  con esta similitud

## Clusterin jerrarquico, mds y kmeans.
...
ggscatter(sol_mds, x = "Dim1", y = "Dim2", 
          ...
          ellipse.type = "convex",
          repel = TRUE,
          title="Gráfico de los  clusters jerárquico ward\n sobre el mds de dos dimensiones"
          )
```
...
https://www.google.com/search?q=eso+es+todo+amigo+dibujo&sxsrf=ALeKk02e30qosW1VPJsrldhRrvEAgsOJFg:1610460881200&tbm=isch&source=iu&ictx=1&fir=R5ngO-hkb1UhkM%252Cq1mk21zQSPsaqM%252C_&vet=1&usg=AI4_-kQQn67Iw7XONK10NQNOEcJfRLU83g&sa=X&ved=2ahUKEwiciv6lypbuAhWLh1wKHT9oBpIQ9QF6BAgKEAE#imgrc=R5ngO-hkb1UhkM


```{r}

knitr::include_graphics("https://www.google.com/search?q=eso+es+todo+amigo+dibujo&sxsrf=ALeKk02e30qosW1VPJsrldhRrvEAgsOJFg:1610460881200&tbm=isch&source=iu&ictx=1&fir=R5ngO-hkb1UhkM%252Cq1mk21zQSPsaqM%252C_&vet=1&usg=AI4_-kQQn67Iw7XONK10NQNOEcJfRLU83g&sa=X&ved=2ahUKEwiciv6lypbuAhWLh1wKHT9oBpIQ9QF6BAgKEAE#imgrc=R5ngO-hkb1UhkM") 
```
